        ...
        <form onSubmit={handleSubmit(onSubmit)} action="#">
          ...
          <div class="mb-6">
            ...
            <input type="password" id="password" required  {...register("password", {
              ...
              class="border  text-sm rounded-lg  block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="•••••••••" />
          </div>
          <div class="mb-6">
            <label for="confirm_password" className="block mb-2 text-sm font-medium">Confirm Password</label>
            <input type="password" id="confirm_password" required  {...register("confirm_password", {
              required: true,
              validate: (val) => {
