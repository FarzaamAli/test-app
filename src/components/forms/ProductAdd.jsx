    ...
    <div className=' p-10 m-auto '>
      <div className=' text-center mb-6 font-bold text-2xl'>ADD ITEMS</div>
       <form onSubmit={handleSubmit(onSubmit)} >
            ...
            {/* <label htmlFor="file" className=" block mb-2 text-sm font-medium">Price</label>
            <input type='file' placeholder='Price of product' className="mb-2 bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-1/2 p-2.5" {...register("file", { required: true })} />
            ...
            <label htmlFor="Description of product" className=" block mb-2 text-sm font-medium">Description</label>
