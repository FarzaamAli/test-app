  ...
  return (
    <div className='flex m-4'>
      <div className='border-double border-4 border-sky-500 p-4 '>
        ...
        <button className="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2 ">Delete</button>
      </div>
    </div>
  )
}
